 ...
 */
public class 视觉词 extends 功能抽象 {
    public static String 替换 = "替换";
    @Override
    public void 功能初始化() {
        // {"词语":"替换成","词性":"替换词"}
        JSONObject jsonObject是 = new JSONObject();
        jsonObject是.put(Cons.对象, Cons.替换成);
        jsonObject是.put(Cons.词性, Cons.替换词);
    ...
    public void 假设句() {
        ...
        //判断是否包含
        boolean 判断结果 = 归属对象值.contains(操作对象值);
