...
public class 判断词 extends 功能抽象 {
    ...
    public void 陈述句() {
        ...
        String 动作结果2 = 拼接字符串.拼接(Cons.新增,Cons.正向判断处理逻辑,截取的判断处理结果);
