...
@Service
public class 空 extends FuncAbstract {
    @Autowired
    Impl逻辑 impl逻辑;
    @PostConstruct
    public void init(){
        //加载初始化逻辑语句
        impl逻辑.保存逻辑("《如果》《遇到》《空》《，》《并且》《后面》《1》《个字》《是》《格》《，》《那就》《把》《当前词》《和》《后面》《1》《个字》《合并为》《1》《个词》");
        impl逻辑.保存逻辑("《如果》《遇到》《空格》《，》《那就》《标记》《当前词》《的》《是否具有分隔符功能》《为》《true》");
    }
