...
@Service
public class 作 extends FuncAbstract {
    @Autowired
    Impl逻辑 impl逻辑;
    @PostConstruct
    public void init(){
        //加载初始化逻辑语句
        impl逻辑.保存逻辑("《如果》《遇到》《作》《，》《并且》《后面1个字》《是》《为》《，》《那就》《把》《当前词》《和》《后面1个字》《合并为》《1》《个词》");
        impl逻辑.保存逻辑("《如果》《遇到》《作》《，》《并且》《后面6个字》《是》《为句子的成分》《，》《那就》《把》《当前词》《和》《后面6个字》《合并为》《1》《个词》");
    }
    public void 功能() {
        分词_作为();
    }
