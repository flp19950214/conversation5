...
public class 记 extends FuncAbstract {
    ...
    public void init(){
        //加载初始化逻辑语句
        impl逻辑.保存逻辑("《如果》《遇到》《记》《，》《并且》《后面1个字》《是》《录》，《那就》《把》《当前词》《和》《后面1个字》《合并为》《1》《个词》");
        impl逻辑.保存逻辑("《如果》《遇到》《记》《，》《并且》《后面6个字》《是》《录成处理逻辑》《，》《那就》《把》《当前词》《和》《后面6个字》《合并为》《1》《个词》");
        impl逻辑.保存逻辑("《如果》《遇到》《记》《，》《并且》《后面6个字》《是》《录当前词对象》《，》《那就》《把》《当前词》《和》《后面6个字》《合并为》《1》《个词》");
    }
