...
@Service
public class 遇 extends FuncAbstract {
    @Autowired
    Impl逻辑 impl逻辑;
    @PostConstruct
    public void init(){
        //加载初始化逻辑语句
        impl逻辑.保存逻辑("《如果》《遇到》《遇》《，》《并且》《后面》《1》《个字》《是》《到》《，》《那就》《把》《当前词》《和》《后面》《1》《个字》《合并为》《1》《个词》");
        impl逻辑.保存逻辑("《如果》《当前词》《是》《遇到》《，》《并且》《前面》《1》《个成分》《是》《如果》《，》《那就》《把》《当前词》《和》《后面》《1》《个分隔符》《之间的内容》《合并为》《1》《个词》");
    }
    ...
    public void 分词(){
        ...
        if (!"到".equals(指定下标的逻辑成分.getString(Cons.词语))) {
            return;
        }
