...
public class 中 extends FuncAbstract {
    ...
    public void init(){
        //加载初始化逻辑语句
        impl逻辑.保存逻辑("《如果》《遇到》《中》《，》《并且》《后面1个字》《是》《有》《，》《那就》《把》《当前词》《和》《后面1个字》《合并为》《1》《个词》");
        impl逻辑.保存逻辑("《如果》《遇到》《中》《，》《并且》《后面1个字》《是》《的》《，》《那就》《把》《当前词》《和》《后面1个字》《合并为》《1》《个词》");
        impl逻辑.保存逻辑("《如果》《遇到》《中》《，》《并且》《后面3个字》《是》《文逗号》《，》《那就》《把》《当前词》《和》《后面3个字》《合并为》《1》《个词》");
        impl逻辑.保存逻辑("《如果》《遇到》《，》《，》《那就》《把》《当前词》《转义为》《中文逗号》");
        impl逻辑.保存逻辑("《如果》《遇到》《中文逗号》《，》《那就》《标记》《当前词》《的》《是否具有分隔符功能》《为》《true》");
        impl逻辑.保存逻辑("《如果》《遇到》《中》《，》《并且》《句子》《的》《句型》《是》《假设句》《，》《并且》《后面5个字》《是》《后面一个字》《，》《那就》《把》《后面5个字》《合并为》《1》《个词》");
    }
    public void 功能() {
        分词_中文逗号();
        分词_中有();
