...
@Service
public class 标 extends FuncAbstract {
    @Autowired
    Impl逻辑 impl逻辑;
    @PostConstruct
    public void init(){
        //加载初始化逻辑语句
        impl逻辑.保存逻辑("《如果》《遇到》《标》《，》《并且》《后面》《1》《个字》《是》《记》《，》《那就》《把》《当前词》《和》《后面》《1》《个字》《合并为》《1》《个词》");
        impl逻辑.保存逻辑("《如果》《遇到》《标》《，》《并且》《后面》《2》《个字》《是》《记为》《，》《那就》《把》《当前词》《和》《后面》《2》《个字》《合并为》《1》《个词》");
    }
    public void 功能() {
        分词_标记为();
        分词_标记();
