...
public class 合 extends FuncAbstract {
    ...
    public void init(){
        //加载初始化逻辑语句
        impl逻辑.保存逻辑("《如果》《遇到》《合》《，》《并且》《后面》《2》《个字》《是》《并为》《，》《那就》《把》《当前词》《和》《后面》《2》《个字》《合并为》《1》《个词》");
        impl逻辑.保存逻辑("《如果》《遇到》《合》《，》《并且》《后面》《4》《个字》《是》《并后的词》《，》《那就》《把》《当前词》《和》《后面》《4》《个字》《合并为》《1》《个词》");
    }
    public void 功能() {
        分词_合并后的词();
        分词_合并为();
