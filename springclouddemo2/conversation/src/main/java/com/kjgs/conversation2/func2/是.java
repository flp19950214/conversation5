...
public class 是 extends FuncAbstract {
    ...
    public void init(){
        //加载初始化逻辑语句
        impl逻辑.保存逻辑("《如果》《遇到》《是》《，》《并且》《后面5个字》《是》《否是无用词》《，》《那就》《把》《当前词》《和》《后面5个字》《合并为》《1》《个词》");
        impl逻辑.保存逻辑("《如果》《遇到》《是》《，》《并且》《后面8个字》《是》《否具有分隔符功能》《，》《那就》《把》《当前词》《和》《后面8个字》《合并为》《1》《个词》");
        impl逻辑.保存逻辑("《如果》《遇到》《是》《，》《并且》《句子》《的》《句型》《是》《假设句》《，》《那就》《把》《当前词》《和》《后面1个分隔符》《之间的内容》《合并为》《1》《个词》");
