...
public class 后 extends FuncAbstract {
    ...
    public void init(){
        ...
        impl逻辑.保存逻辑("《如果》《遇到》《数字》《，》《并且》《前面》《1》《个成分》《是》《后面》《，》《并且》《后面》《1》《个成分》《是》《个字》《，》《那就》《把》《前面》《1》《个成分》《和》《当前词》《，》《再和》《后面》《1》《个成分》《合并为》《1》《个词》");
        impl逻辑.保存逻辑("《如果》《遇到》《数字》《，》《并且》《前面》《1》《个成分》《是》《后面》《，》《并且》《后面》《1》《个成分》《是》《个成分》《，》《那就》《把》《前面》《1》《个成分》《和》《当前词》《，》《再和》《后面》《1》《个成分》《合并为》《1》《个词》");
        impl逻辑.保存逻辑("《如果》《遇到》《数字》《，》《并且》《前面》《1》《个成分》《是》《后面》《，》《并且》《后面》《1》《个成分》《是》《个分隔符》《，》《那就》《把》《前面》《1》《个成分》《和》《当前词》《，》《再和》《后面》《1》《个成分》《合并为》《1》《个词》");
        impl逻辑.保存逻辑("《如果》《遇到》《数字》《，》《并且》《前面》《1》《个成分》《是》《后面第》《，》《并且》《后面》《1》《个成分》《是》《个名词》《，》《那就》《把》《前面》《1》《个成分》《和》《当前词》《，》《再和》《后面》《1》《个成分》《合并为》《1》《个词》");
    }
