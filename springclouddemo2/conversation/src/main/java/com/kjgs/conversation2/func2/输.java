...
public class 输 extends FuncAbstract {
    ...
    public void init(){
        //加载初始化逻辑语句
        impl逻辑.保存逻辑("《如果》《遇到》《输》《，》《并且》《后面》《1》《个字》《是》》出《《，》《那就》《把》《当前词》《和》《后面》《1》《个字》《合并为》《1》《个词》");
        impl逻辑.保存逻辑("《如果》《遇到》《输》《，》《并且》《后面》《4》《个字》《是》《入的句子》《，》《那就》《把》《当前词》《和》《后面》《4》《个字》《合并为》《1》《个词》");
        impl逻辑.保存逻辑("《如果》《遇到》《输》《，》《并且》《后面》《4》《个字》《是》《出的对象》《，》《那就》《把》《当前词》《和》《后面》《4》《个字》《合并为》《1》《个词》");
        impl逻辑.保存逻辑("《如果》《遇到》《输》《，》《并且》《后面》《9》《个字》《是》《入句子的数据表下标》《，》《那就》《把》《当前词》《和》《后面》《9》《个字》《合并为》《1》《个词》");
