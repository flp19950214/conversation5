...
public class 输 extends FuncAbstract {
    ...
    public void init(){
        //加载初始化逻辑语句
        impl逻辑.保存逻辑("《如果》《遇到》《输》《，》《并且》《后面1个字》《是》》出《《，》《那就》《把》《当前词》《和》《后面1个字》《合并为》《1》《个词》");
        impl逻辑.保存逻辑("《如果》《遇到》《输》《，》《并且》《后面4个字》《是》《入的句子》《，》《那就》《把》《当前词》《和》《后面4个字》《合并为》《1》《个词》");
        impl逻辑.保存逻辑("《如果》《遇到》《输》《，》《并且》《后面4个字》《是》《出的对象》《，》《那就》《把》《当前词》《和》《后面4个字》《合并为》《1》《个词》");
        impl逻辑.保存逻辑("《如果》《遇到》《输》《，》《并且》《后面8个字》《是》《入句子的成分集合》《，》《那就》《把》《当前词》《和》《后面8个字》《合并为》《1》《个词》");
        impl逻辑.保存逻辑("《如果》《遇到》《输》《，》《并且》《后面9个字》《是》《入句子的数据表下标》《，》《那就》《把》《当前词》《和》《后面9个字》《合并为》《1》《个词》");
        impl逻辑.保存逻辑("《如果》《遇到》《输出》《，》《并且》《句子》《的》《句型》《是》《假设句》《，》《那就》《把》《后面的内容》《合并为》《1》《个词》");
    }
