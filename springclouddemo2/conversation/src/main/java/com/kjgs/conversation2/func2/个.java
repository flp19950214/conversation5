...
public class 个 extends FuncAbstract {
    ...
    @PostConstruct
    public void init(){
        impl逻辑.保存逻辑("《如果》《遇到》《个》《，》《并且》《后面》《1》《个字》是《字》《，》《那就》《把》《当前词》《和》《后面》《1》《个字》《合并为》《1》《个词》");
        impl逻辑.保存逻辑("《如果》《遇到》《个》《，》《并且》《后面》《1》《个字》是《词》《，》《那就》《把》《当前词》《和》《后面》《1》《个字》《合并为》《1》《个词》");
        //加载初始化逻辑语句《》《》《》《
        impl逻辑.保存逻辑("《如果》《遇到》《成》《，》《并且》《后面》《1》《个字》《是》《分》《，》《那就》《把》《当前词》《和》《后面》《1》《个字》《合并为》《1》《个词》");
        impl逻辑.保存逻辑("《如果》《遇到》《个》《，》《并且》《后面》《2》《个字》《是》《成分》《，》《那就》《把》《当前词》《和》《后面》《2》《个字》《合并为》《1》《个词》");
        impl逻辑.保存逻辑("《如果》《遇到》《个》《，》《并且》《后面》《2》《个字》《是》《名词》《，》《那就》《把》《当前词》《和》《后面》《2》《个字》《合并为》《1》《个词》");
//        impl逻辑.保存逻辑("《如果》《遇到》《个》《，》《并且》《后面》《3》《个字》《是》《属性是》《，》《那就》《把》《当前词》《和》《后面》《3》《个字》《合并为》《1》《个词》");
        impl逻辑.保存逻辑("《如果》《遇到》《个》《，》《并且》《后面》《3》《个字》《是》《分隔符》《，》《那就》《把》《当前词》《和》《后面》《3》《个字》《合并为》《1》《个词》");
    }
    public void 功能() {
        分词();
    }
