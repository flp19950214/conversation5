...
('如果下一个词的词性是数字', '《下一个词的词性是否是数字》《作为》被判断的对象；判断的对象《是》true；《执行判断等于方法》；');
('如果下一个词的词性是数字，那么合并下一个词作为新的处理词语', '《下一个词的词性是否是数字》《作为》');
('如果下一个词的词性不是数字，那么合并下一个词作为新的处理词语', '《下一个词的词性是否是数字》《作为》判断条件；《合并下一个词作为新的处理词语》《》');
('如果下一个词的词性不是数字，那么合并下一个词作为新的处理词语', '《下一个词的词性是否是数字》《作为》');
